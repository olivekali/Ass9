...
# ╔═╡ 5eabc9ae-fc26-4787-8dd2-247959896257
CHiT = ChisqTest(F_val)

# ╔═╡ 2c07bb1b-a013-4ca5-afc4-639d2301dd16
println("Chi-Squared Test p-value: ", pvalue(CHiT))
...
SCh_id = machine(Reg_M, X, Y, scitype_check_level=0)
...
manifest_format = "2.0"
project_hash = "f57697d95c6dc0886e32a46673b884488f26e06a"
